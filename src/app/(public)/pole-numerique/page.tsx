        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="mt-8 grid gap-10 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">Logiciels et abonnements professionnels, formations, création web et applications, hébergement, infrastructure et accompagnement numérique pour particuliers, professionnels et entreprises.</p>
      ...
      <section className="bg-white px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <p className="text-sm font-black uppercase tracking-[0.17em] text-ocean">Pôle numérique</p>
            <h2 className="mt-4 text-3xl font-black text-ink sm:text-5xl">Acheter, apprendre et construire au même endroit.</h2>
            <p className="mt-5 text-lg leading-8 text-slate-600">Le pôle numérique de DG AFRIQUE rassemble les outils, les compétences et les services nécessaires pour équiper, former et digitaliser les projets.</p>
          </div>

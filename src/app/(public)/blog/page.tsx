...
export default async function BlogPage() {
  ...
  return (
    <>
      <section className="bg-ink px-4 py-20 text-white sm:px-6 lg:px-8"><div className="mx-auto max-w-7xl"><p className="text-sm font-black uppercase tracking-[0.17em] text-cyan">Pôle numérique · Conseils et ressources</p><h1 className="mt-4 text-4xl font-black sm:text-6xl">Actualités & conseils numériques</h1><p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">Des contenus utiles pour comprendre les outils numériques et prendre de meilleures décisions.</p></div></section>

...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="bg-dgIvory px-4 py-16 sm:px-6 lg:px-8"><div className="mx-auto max-w-7xl rounded-[2rem] bg-white p-8 shadow-sm sm:p-10"><p className="text-sm font-black uppercase tracking-[0.16em] text-dgGreen">Notre pôle numérique</p><h2 className="mt-3 text-3xl font-black text-dgNavy">GamaDigit</h2><p className="mt-4 max-w-3xl leading-8 text-slate-600">GamaDigit propose des logiciels et abonnements professionnels, des formations, des services web et applicatifs, de l’hébergement ainsi que des solutions de digitalisation pour les entreprises.</p><Link href="/gamadigit" className="mt-6 inline-flex items-center gap-2 font-black text-dgGreen">Découvrir GamaDigit <ArrowRight className="h-4 w-4"/></Link></div></section>

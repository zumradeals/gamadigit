...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: `${baseUrl}/programme-zumra`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/programme-zumra/charte`, lastModified: now, changeFrequency: 'monthly', priority: 0.55 },
    ...
    ...families
      ...
      .map((family) => ({ url: `${baseUrl}/services/${family.slug}`, lastModified: now, changeFrequency: 'monthly' as const, priority: 0.75 })),
    ...products.map((product) => ({ url: `${baseUrl}/logiciels/${product.slug}`, lastModified: now, changeFrequency: 'monthly' as const, priority: 0.75 })),
    ...posts.map((post) => ({ url: `${baseUrl}/blog/${post.slug}`, lastModified: now, changeFrequency: 'monthly' as const, priority: 0.7 })),
  ];
}

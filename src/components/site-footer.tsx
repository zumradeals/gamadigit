  ...
  return (
    <footer className="bg-dgNavy text-slate-300">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 md:grid-cols-2 lg:grid-cols-4 lg:px-8">
        ...
        <div>
          <h2 className="font-bold text-white">DG AFRIQUE</h2>
          <div className="mt-4 space-y-3 text-sm">
            <Link href="/a-propos" className="block hover:text-white">À propos</Link>
            <Link href="/#poles" className="block hover:text-white">Nos pôles</Link>
            <Link href="/opportunites" className="block hover:text-white">Opportunités</Link>
            <Link href="/investisseurs-partenaires" className="block hover:text-white">Investisseurs & partenaires</Link>
          </div>
        </div>
        <div>
